...
QTN_IMPORT_EXPORT QByteArray qtnFileButtonIconAttr();
QTN_IMPORT_EXPORT QByteArray qtnFileClearButtonAttr();
QTN_IMPORT_EXPORT QByteArray qtnFileClearButtonIconAttr();
QTN_IMPORT_EXPORT QByteArray qtnFileClearButtonTextAttr();
QTN_IMPORT_EXPORT QByteArray qtnFileClearButtonToolTipAttr();
QTN_IMPORT_EXPORT QByteArray qtnFileBrowseButtonAttr();
QTN_IMPORT_EXPORT QByteArray qtnFileBrowseButtonIconAttr();
QTN_IMPORT_EXPORT QByteArray qtnFileBrowseButtonTextAttr();
QTN_IMPORT_EXPORT QByteArray qtnFileBrowseButtonToolTipAttr();
